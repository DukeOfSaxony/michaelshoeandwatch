        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 fade-in stagger-delay-2">
            ...
            <form id="contact-form" className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                className="w-full bg-[#aa1e1e] text-white font-heading font-semibold py-3 px-6 rounded hover:bg-opacity-90 transition-colors pulse-animation"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="bg-[#1c1c1c] text-white rounded-lg shadow-md p-8 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mt-1 mr-4 text-[#ffb340]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
